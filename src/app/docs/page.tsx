...

{
  ...
  "timestamp": "{{datetime}}"
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2">
          ...
          <section className="panel p-5">
            <h2 className="font-semibold">API key security</h2>
            <p className="muted mt-2 text-sm leading-6">
          ...
          <section className="panel p-5">
            <h2 className="font-semibold">Dynamic values</h2>
            <p className="muted mt-2 text-sm leading-6">
          ...
          <section className="panel p-5">
            <h2 className="font-semibold">Browser-ready</h2>
            <p className="muted mt-2 text-sm leading-6">
              Public mocks include CORS support and safe request logging.
            </p>
          </section>
          <section className="panel p-5">
            <h2 className="font-semibold">30-day retention</h2>
            <p className="muted mt-2 text-sm leading-6">
